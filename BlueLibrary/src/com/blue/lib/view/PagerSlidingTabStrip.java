...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int lastScrollX = 0, distanceX = 0;

	private int tabBackgroundResId = R.drawable.pstb_background_tab;

	private Locale locale;

	private Runnable toChildRun;
	...
	private void scrollToChild(int position, int offset) {
		...
		if (newScrollX != lastScrollX) {
			// distanceX = (newScrollX - lastScrollX) / 10;
