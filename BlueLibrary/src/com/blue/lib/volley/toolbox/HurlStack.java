...
public class HurlStack implements HttpStack {
	...
	public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders) throws IOException,
		...
		// String url =
		// "http://x.xiushuang.com/sdk/forum_list/1/?sid=&cid=2&gameroom=祖安";
		...
		// connection.setRequestProperty(HTTP.USER_AGENT,
		// AppManager.getInstance().getUserAgent());// TODO
		Log.d("volley_start", "HurlStack:----" + url);
	...
	private static void addBodyIfExists(HttpURLConnection connection, Request<?> request) throws IOException,
		...
		if (body != null) {
			...
			out.write(body);
			out.close();
			Log.d("Volley__start__body", "HurlStack:----" + new String(body));
		}
	}
}
