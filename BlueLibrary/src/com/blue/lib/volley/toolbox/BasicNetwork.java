...
package com.blue.lib.volley.toolbox;
...
import com.blue.lib.volley.AuthFailureError;
import com.blue.lib.volley.Cache;
import com.blue.lib.volley.Network;
import com.blue.lib.volley.NetworkError;
import com.blue.lib.volley.NetworkResponse;
import com.blue.lib.volley.NoConnectionError;
import com.blue.lib.volley.Request;
import com.blue.lib.volley.RetryPolicy;
import com.blue.lib.volley.ServerError;
import com.blue.lib.volley.TimeoutError;
import com.blue.lib.volley.VolleyError;
import com.blue.lib.volley.VolleyLog;
...
public class BasicNetwork implements Network {
	...
	public NetworkResponse performRequest(Request<?> request) throws VolleyError {
		...
		while (true) {
			...
			try {
				...
				L.d("Volley_header", request.toString());
				...
				// Log.d("response_header", name + ":" +
				// responseHeaders.get(name));
				// }
				try {
					L.d("volley_over", "BasicNetwork---" + new JSONObject(new String(responseContents)));
				} catch (JSONException e) {
					L.d("volley_over", "BasicNetwork_noJSONOBject" + new String(responseContents));
					e.printStackTrace();
				}
	...
	private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
		// Log.d("volley_NetWork_over", EntityUtils.toString(entity, "UTF-8"));
